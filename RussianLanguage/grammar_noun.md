...
|                        | И.п. (1) | Р.п. (2)  | Д.п. (3) | В.п. (4) | Т.п. (5) | П.п. (6) |
| ---------------------- | -------- | --------- | -------- | -------- | -------- | -------- |
| 硬词干 (стол, газета)     | -ы / -а  | -ов / -   | -ам      | = 1/2    | -ами     | -ах      |
| 软词干 (словарь, здание ) | -и / -я  | -ей / -ий | -ям      | = 1/2    | -ями     | -ях      |
...
| (1)           | (2)      | М.п.(1) | М.п.(2)       |
| ------------- | -------- | ------- | ------------- |
| друг          | друга    | друзья  | друзей        |
| мать          | матери   | матери  | матерей       |
| дочь          | дочери   | дочери  | дочерей       |
| сестра        | сестры   | сёстры  | сестёр        |
| брат          | брата    | братья  | братьев       |
| отец          | отца     | отцы    | отцов         |
| ребёнок       | ребёнка  | дети    | детей         |
| человек       | человека | люди    | людей         |
| девушка       |          |         | девушек       |
| студент**ка** |          |         | студент**ок** |

| (1)         | (2)     | М.п(1)  | М.п.(2)      |
| ----------- | ------- | ------- | ------------ |
| стул        | стула   | стулья  | стульев      |
| лист        | листа   | листья  | листьев      |
| время       | времени | времена | времён       |
|             |         | деньги  | денег        |
| час         | часа    | часы    | часов        |
| раз         | раза    | разы    | раз          |
| сум**ка**   |         |         | сум**ок**    |
...
#### сколько + они-2
5-20/сколько/несколько/много/мало + они-2  
> нпр.
> 1 **раз**
> 2, 3, 4 **раза**
> 5-20/(не)сколько/много/мало **раз**

> 特殊：
> 5-20/сколько/несколько **человек**
> много/мало **людей**
...
##### Кто будет/был/работать/стать кем(5)
